...
public class ColorLoader implements IdentifiableResourceReloadListener {
    ...
    public ResourceLocation getFabricId() {
        return ResourceLocation.fromNamespaceAndPath("tiers", "color_loader");
    }

    @Override
    public CompletableFuture<Void> reload(PreparationBarrier preparationBarrier, ResourceManager resourceManager, ProfilerFiller preparationsProfiler, ProfilerFiller reloadProfiler, Executor taskExecutor, Executor reloadExecutor) {
        ...
        if (ConfigScreen.ownProfile == null) {
            ConfigScreen.ownProfile = new PlayerProfile(Minecraft.getInstance().getGameProfile().getName(), false);
