...
public class ConfigScreen extends Screen {
    ...
    public void extractRenderState(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (!useOwnProfile)
            graphics.blit(RenderPipelines.GUI_TEXTURED, playerAvatarTexture, centerX - height / 10 / 2, avatarY, 0, 0, height / 10, (int) (height / 4.166), height / 10, (int) (height / 4.166));
        else
            drawPlayerAvatar(graphics, centerX, avatarY);

        graphics.centeredText(font, useOwnProfile ? ownProfile.getFullName() : defaultProfile.getFullName(), centerX, avatarY - 12, CommonColors.WHITE);

        graphics.centeredText(font, Component.literal("Globální žebříčky"), centerX, distance + 92, CommonColors.GRAY);
        graphics.blit(RenderPipelines.GUI_TEXTURED, MCTiersProfile.MCTIERS_IMAGE, centerX - 120 - 64, distance + 104 + 4, 0, 0, 128, 24, 128, 24);
        graphics.blit(RenderPipelines.GUI_TEXTURED, PvPTiersProfile.PVPTIERS_IMAGE, centerX - 12, distance + 104 + 4, 0, 0, 24, 24, 24, 24);
        graphics.blit(RenderPipelines.GUI_TEXTURED, SubtiersProfile.SUBTIERS_IMAGE, centerX + 120 - 15, distance + 104, 0, 0, 30, 30, 30, 30);

        graphics.centeredText(font, Component.literal("CZ/SK žebříčky"), centerX, distance + 154, CommonColors.GRAY);
        graphics.blit(RenderPipelines.GUI_TEXTURED, CZSKTiersProfile.CZSKTIERS_IMAGE, centerX - 120 - 13, distance + 166, 0, 0, 26, 26, 26, 26);
        graphics.blit(RenderPipelines.GUI_TEXTURED, CZSKB0tProfile.CZSK_B0T_IMAGE, centerX - 13, distance + 166, 0, 0, 26, 26, 26, 26);
        graphics.blit(RenderPipelines.GUI_TEXTURED, CZSKSubtiersProfile.CZSK_SUBTIERS_IMAGE, centerX + 120 - 13, distance + 166, 0, 0, 26, 26, 26, 26);
    ...
    protected void init() {
        ...
        leftMCTiers = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(1, TiersClient.DisplayStatus.LEFT)).bounds(centerX - 120 - 10 - 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display MCTiers on the left"))).build();
        centerMCTiers = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(1, TiersClient.DisplayStatus.OFF)).bounds(centerX - 120 - 10, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Disable MCTiers"))).build();
        rightMCTiers = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(1, TiersClient.DisplayStatus.RIGHT)).bounds(centerX - 120 - 10 + 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display MCTiers on the right"))).build();

        leftPvPTiers = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(2, TiersClient.DisplayStatus.LEFT)).bounds(centerX - 10 - 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display PvPTiers on the left"))).build();
        centerPvPTiers = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(2, TiersClient.DisplayStatus.OFF)).bounds(centerX - 10, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Disable PvPTiers"))).build();
        rightPvPTiers = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(2, TiersClient.DisplayStatus.RIGHT)).bounds(centerX - 10 + 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display PvPTiers on the right"))).build();

        leftSubtiers = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(3, TiersClient.DisplayStatus.LEFT)).bounds(centerX + 120 - 10 - 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display Subtiers on the left"))).build();
        centerSubtiers = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(3, TiersClient.DisplayStatus.OFF)).bounds(centerX + 120 - 10, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Disable Subtiers"))).build();
        rightSubtiers = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(3, TiersClient.DisplayStatus.RIGHT)).bounds(centerX + 120 - 10 + 24, distance + 130, 20, 20).tooltip(Tooltip.create(Component.literal("Display Subtiers on the right"))).build();

        // Row 2: CZSKTiers, CZSKB0t, CZSKSubtiers
        leftCZSKTiers = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(4, TiersClient.DisplayStatus.LEFT)).bounds(centerX - 120 - 10 - 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSKTiers.com on the left"))).build();
        centerCZSKTiers = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(4, TiersClient.DisplayStatus.OFF)).bounds(centerX - 120 - 10, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Disable CZSKTiers.com"))).build();
        rightCZSKTiers = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(4, TiersClient.DisplayStatus.RIGHT)).bounds(centerX - 120 - 10 + 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSKTiers.com on the right"))).build();

        leftCZSKB0t = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(5, TiersClient.DisplayStatus.LEFT)).bounds(centerX - 10 - 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSK (b0tfleyz) on the left"))).build();
        centerCZSKB0t = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(5, TiersClient.DisplayStatus.OFF)).bounds(centerX - 10, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Disable CZSK (b0tfleyz)"))).build();
        rightCZSKB0t = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(5, TiersClient.DisplayStatus.RIGHT)).bounds(centerX - 10 + 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSK (b0tfleyz) on the right"))).build();

        leftCZSKSubtiers = Button.builder(Component.literal("←"), (_) -> setTierlistPosition(6, TiersClient.DisplayStatus.LEFT)).bounds(centerX + 120 - 10 - 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSK Subtiers on the left"))).build();
        centerCZSKSubtiers = Button.builder(Component.literal("●"), (_) -> setTierlistPosition(6, TiersClient.DisplayStatus.OFF)).bounds(centerX + 120 - 10, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Disable CZSK Subtiers"))).build();
        rightCZSKSubtiers = Button.builder(Component.literal("→"), (_) -> setTierlistPosition(6, TiersClient.DisplayStatus.RIGHT)).bounds(centerX + 120 - 10 + 24, distance + 194, 20, 20).tooltip(Tooltip.create(Component.literal("Display CZSK Subtiers on the right"))).build();
