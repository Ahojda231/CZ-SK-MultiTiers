...
public class PlayerSearchResultScreen extends Screen {
    ...
    public void init() {
        ...
        globalTabButton = Button.builder(Component.literal("Globální"), (_) -> switchTab(0))
                .bounds(5, 5, 75, 20)
        ...
        czskTabButton = Button.builder(Component.literal("CZ/SK"), (_) -> switchTab(1))
                .bounds(83, 5, 75, 20)
        ...
        if (selectedTab == 0) {
            ...
            addRenderableWidget(Button.builder(Icons.CYCLE, (_) -> playerProfile.updateTierlistProfiles(4)).bounds(5, height - 20 - 5 - 22, 20, 20).tooltip(Tooltip.create(Component.literal("Update CZSKTiers.com results"))).build());
            addRenderableWidget(Button.builder(Icons.CYCLE, (_) -> playerProfile.updateTierlistProfiles(5)).bounds(5 + 24, height - 20 - 5 - 22, 20, 20).tooltip(Tooltip.create(Component.literal("Update CZSK (b0tfleyz) results"))).build());
            addRenderableWidget(Button.builder(Icons.CYCLE, (_) -> playerProfile.updateTierlistProfiles(6)).bounds(5 + 24 + 24, height - 20 - 5 - 22, 20, 20).tooltip(Tooltip.create(Component.literal("Update CZSK Subtiers results"))).build());
        }
    }
}