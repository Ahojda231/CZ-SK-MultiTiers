...
public class ColorLoader implements IdentifiableResourceReloadListener {
    ...
    @Override
    public CompletableFuture<Void> reload(PreparationBarrier preparationBarrier, ResourceManager resourceManager, Executor taskExecutor, Executor reloadExecutor) {
