...
public class CZSKB0tProfile extends SuperProfile {
    public static final ResourceLocation CZSK_B0T_IMAGE = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/czsk_b0tfleyz_logo.png");
    private static final String SNAPSHOT_URL = "https://b0tfleyz.github.io/CZSKtiers/data/czsktiers/overall.json";
