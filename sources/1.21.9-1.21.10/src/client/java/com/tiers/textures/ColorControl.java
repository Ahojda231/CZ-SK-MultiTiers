...
public class ColorControl {
    ...
    public static void updateColors(JsonObject jsonObject) {
        ...
        Icons.GLOBE = Component.literal("\uF000").setStyle(Style.EMPTY.withColor(getColorMinecraftStandard("region")).withFont(new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath("minecraft", "misc"))));
        Icons.OVERALL = Component.literal("\uF001").setStyle(Style.EMPTY.withColor(getColorMinecraftStandard("overall")).withFont(new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath("minecraft", "misc"))));
    }
