...
public class Icons {
    public static ResourceLocation identifierMCTiers = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/pvptiers");
    public static ResourceLocation identifierPvPTiers = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/pvptiers");
    public static final ResourceLocation identifierSubtiers = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/subtiers");

    public static ResourceLocation identifierMCTiersTags = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/pvptiers-tags");
    public static ResourceLocation identifierPvPTiersTags = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/pvptiers-tags");
    public static final ResourceLocation identifierSubtiersTags = ResourceLocation.fromNamespaceAndPath("minecraft", "gamemodes/subtiers-tags");

    private static final FontDescription fontDescription = new FontDescription.Resource((ResourceLocation.fromNamespaceAndPath("minecraft", "misc")));
