...
public class TiersClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        KeyMapping.Category category = KeyMapping.Category.register(ResourceLocation.parse("tiers"));
        ...
        ResourceLoader.get(PackType.CLIENT_RESOURCES).registerReloader(ResourceLocation.parse("tiers"), new ColorLoader());
